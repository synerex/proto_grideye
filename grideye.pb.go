...
type GridEyeEvent struct {
	...
	Temps []float32            `protobuf:"fixed32,5,rep,packed,name=temps,proto3" json:"temps,omitempty"`
}
...
func (x *GridEyeEvent) GetTemps() []float32 {
	if x != nil {
		return x.Temps
	}
	return nil
...
var file_grideye_proto_rawDesc = []byte{
	...
	0x05, 0x20, 0x03, 0x28, 0x02, 0x52, 0x05, 0x74, 0x65, 0x6d, 0x70, 0x73, 0x22, 0x38, 0x0a, 0x08,
